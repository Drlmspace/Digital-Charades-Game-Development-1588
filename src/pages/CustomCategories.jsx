  ...
  return (
    <div className="min-h-screen p-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h1 className="text-4xl font-bold text-white mb-4">Custom Categories</h1>
          <p className="text-white/80 text-lg">
            Create your own categories and add custom cards ({Object.keys(state.customCategories).length} categories created)
          </p>
        </motion.div>
            ...
            {showCategoryForm && (
              ...
              >
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl border-0 focus:ring-2 focus:ring-blue-400 outline-none text-sm"
                />
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h3 className={`font-bold ${selectedCategory === categoryName ? 'text-gray-800' : 'text-white'}`}>
                            {category.name}
                          </h3>
                          <p className={`text-sm ${selectedCategory === categoryName ? 'text-gray-600' : 'text-white/70'}`}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <input
                        ...
                        className="px-4 py-3 rounded-xl border-0 focus:ring-2 focus:ring-blue-400 outline-none"
                      />
                        ...
                        >
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              ...
                              <h4 className="text-lg font-bold text-gray-800 mb-1">{card.text}</h4>
